##################################################################
##  fetch_growth_data.R: function for importing growth data and ##
##  calculating crowding indices. Returns a data frame.         ##
##################################################################

##  Author: Peter Adler

fetchGdat <- function(doSite, doSpp, speciesList, datadir, distWts){
  
  growDfile=paste0(datadir,doSite,"/",doSpp,"/growDnoNA.csv")
