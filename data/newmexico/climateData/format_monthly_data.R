...
T<-read.csv("c:/repos/driversdata/data/newmexico/climateData/monthly_mean_temp.csv")
P<-read.csv("c:/repos/driversdata/data/newmexico/climateData/total_monthly_ppt.csv")
...
write.csv(dat, "c:/repos/driversdata/data/newmexico/climateData/monthClim.csv")
